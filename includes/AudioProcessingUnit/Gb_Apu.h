...
constexpr unsigned start_addr = 0xFF10;
constexpr unsigned end_addr = 0xFF3F;
constexpr unsigned register_count = end_addr - start_addr + 1;
...
public:
	...
	bool is_channel1_enabled() {
		return square1.enabled;
	}
